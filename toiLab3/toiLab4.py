...
fig = plt.figure()
# k_means_ax = fig.add_subplot(3, 2, 1)
# k_means_ax.set_title('a')
# m_shift_ax = fig.add_subplot(3, 1, 2)
# m_shift_ax.set_title('y')
# spectral_c_ax = fig.add_subplot(3, 1, 3)
# spectral_c_ax.set_title('ee')
